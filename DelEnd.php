...
<body>
    <form action="http://localhost/Desafio1/BackDatas/ByeEnd.php" method="POST">
        <table class="table table-hover">
            ...
            <td><input type="text" name="Email_Usuario" placeholder="Email do Usuario" value="<?php echo $Idade;?>"></td></tr>
            <tr>
            ...
            <td><a href="#"><button type="submit" class="btn btn-info">Salvar Alteração</a></td></table>
</form>
</body>
</html>